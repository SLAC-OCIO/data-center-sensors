...
(function ()
{
    ...
    Tests.prototype.set_file_is_test = function() {
        ...
        // Create the test, which will add it to the table of tests
        async_test();
    };
    ...
    */
     ...
     * with children it is possible to just use a table
     * [node1, node2, node3]
     *
     * Usage:
     *
     * render(template, substitutions) - take a template and an object mapping
     * variable names to parameters and return either a DOM node or a table of DOM nodes
     *
    ...
    function forEach_windows(callback) {
        ...
        if (!cache) {
            ...
            while (w != w.parent) {
                ...
                // `location.ancestorOrigins` property which returns an ordered table of
